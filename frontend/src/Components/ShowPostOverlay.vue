                ...
                <div class="md:max-w-[500px] w-full relative">
                    <div class="flex items-center justify-between p-3 border-b">
                        <div class="flex items-center">
                            <img class="rounded-full w-[38px] h-[38px]" :src="post.user.user_image">
                        ...
                        <button
                            v-if="session.user === post.user.id"
                            ...
                            <div class="flex items-center justify-between">
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-4 font-extrabold text-[15px]">
                                        ...
                                        <span class="font-light text-gray-700 text-sm">{{ comment.creation }}</span>
                                    </div>
                                </div>

                                <DotsHorizontal
                                    v-if="session.user === comment.user.id"
